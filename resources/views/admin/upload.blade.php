...
<script src="{{ asset('/jQueryFileUpload/js/jquery.fileupload-process.js')}}"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="{{ asset('/jQueryFileUpload/js/jquery.fileupload-image.js')}}"></script>
<!-- The File Upload audio preview plugin -->
<script src="{{ asset('/jQueryFileUpload/js/jquery.fileupload-audio.js')}}"></script>
<!-- The File Upload video preview plugin -->
<script src="{{ asset('/jQueryFileUpload/js/jquery.fileupload-video.js')}}"></script>
